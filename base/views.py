...
def form_donation(request, pk):
    ...
    if donation.is_fulfilled():  # Mengecek apakah target dana sudah terpenuhi
        messages.warning(request, 'Target dana sudah terpenuhi. Anda tidak dapat melakukan donasi lagi.')
        return redirect('donasi', pk=pk)
